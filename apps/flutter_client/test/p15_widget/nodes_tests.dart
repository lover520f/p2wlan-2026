...
void _registerNodesTests() {
  ...
  testWidgets(
    'Nodes keeps online-first order stable across live peer updates',
    (tester) async {
      final base = (await tester.runAsync(_loadFixtureSnapshot))!;
      ...
      // The default view must retain the lifecycle positions instead.
